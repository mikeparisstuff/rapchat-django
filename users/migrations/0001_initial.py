...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'users_profile_friends')
        ...
        db.create_table(u'users_friendrequest', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sender', self.gf('django.db.models.fields.related.ForeignKey')(related_name='request_sender_set', to=orm['auth.User'])),
            ('requested', self.gf('django.db.models.fields.related.ForeignKey')(related_name='request_receiver_set', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'users', ['FriendRequest'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'users_profile_friends'))

        # Deleting model 'FriendRequest'
        db.delete_table(u'users_friendrequest')
    ...
    models = {
        ...
        u'users.friendrequest': {
            'Meta': {'object_name': 'FriendRequest'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_accepted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'requested': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'request_receiver_set'", 'to': u"orm['auth.User']"}),
            'sender': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'request_sender_set'", 'to': u"orm['auth.User']"})
        },
        u'users.profile': {
