...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FeedbackMessage.message'
        db.alter_column(u'feedback_feedbackmessage', 'message', self.gf('django.db.models.fields.TextField')(max_length=2000))

    def backwards(self, orm):

        # Changing field 'FeedbackMessage.message'
        db.alter_column(u'feedback_feedbackmessage', 'message', self.gf('django.db.models.fields.CharField')(max_length=2000))
    ...
    models = {
        ...
        u'feedback.feedbackmessage': {
            'Meta': {'object_name': 'FeedbackMessage'},
