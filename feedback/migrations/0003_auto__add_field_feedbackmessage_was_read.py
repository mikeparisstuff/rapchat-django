...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FeedbackMessage.was_read'
        db.add_column(u'feedback_feedbackmessage', 'was_read',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FeedbackMessage.was_read'
        db.delete_column(u'feedback_feedbackmessage', 'was_read')
