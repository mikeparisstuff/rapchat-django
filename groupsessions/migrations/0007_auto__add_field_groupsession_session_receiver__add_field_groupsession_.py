...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GroupSession.session_receiver'
        db.add_column(u'groupsessions_groupsession', 'session_receiver',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='battle_receiver_set', null=True, blank=True, to=orm['users.Profile']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'GroupSession.session_receiver'
        db.delete_column(u'groupsessions_groupsession', 'session_receiver_id')
