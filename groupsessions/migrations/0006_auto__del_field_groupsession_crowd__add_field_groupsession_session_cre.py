...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GroupSession.crowd'
        db.delete_column(u'groupsessions_groupsession', 'crowd_id')

        # Adding field 'GroupSession.session_creator'
        db.add_column(u'groupsessions_groupsession', 'session_creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['users.Profile'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'GroupSession.crowd'
        db.add_column(u'groupsessions_groupsession', 'crowd',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['crowds.Crowd']),
                      keep_default=False)

        # Deleting field 'GroupSession.session_creator'
        db.delete_column(u'groupsessions_groupsession', 'session_creator_id')
    ...
    models = {
        ...
        u'groupsessions.groupsession': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'session_creator': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['users.Profile']", 'null': 'True', 'blank': 'True'}),
