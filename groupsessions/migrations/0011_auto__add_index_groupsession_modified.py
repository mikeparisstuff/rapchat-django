...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'GroupSession', fields ['modified']
        db.create_index(u'groupsessions_groupsession', ['modified'])


    def backwards(self, orm):
        # Removing index on 'GroupSession', fields ['modified']
        db.delete_index(u'groupsessions_groupsession', ['modified'])
