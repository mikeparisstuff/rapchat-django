...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'groupsessions_comment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Profile'])),
            ('session', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['groupsessions.GroupSession'])),
            ('text', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'groupsessions', ['Comment'])

        # Adding model 'Like'
        db.create_table(u'groupsessions_like', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'groupsessions', ['Like'])

        # Deleting field 'GroupSession.video_url'
        db.delete_column(u'groupsessions_groupsession', 'video_url')


    def backwards(self, orm):
        # Deleting model 'Comment'
        db.delete_table(u'groupsessions_comment')

        # Deleting model 'Like'
        db.delete_table(u'groupsessions_like')

        # Adding field 'GroupSession.video_url'
        db.add_column(u'groupsessions_groupsession', 'video_url',
    ...
    models = {
        ...
        u'crowds.crowd': {
            'Meta': {'object_name': 'Crowd'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'members': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['users.Profile']", 'symmetrical': 'False'}),
        ...
        u'groupsessions.groupsession': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'crowd': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['crowds.Crowd']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
