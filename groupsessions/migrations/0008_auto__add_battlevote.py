...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BattleVote'
        db.create_table(u'groupsessions_battlevote', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('voter', self.gf('django.db.models.fields.related.ForeignKey')(related_name='voter_set', to=orm['users.Profile'])),
            ('voted_for', self.gf('django.db.models.fields.related.ForeignKey')(related_name='voted_for_set', to=orm['users.Profile'])),
            ('battle', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['groupsessions.GroupSession'])),
            ('is_for_creator', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'groupsessions', ['BattleVote'])


    def backwards(self, orm):
        # Deleting model 'BattleVote'
        db.delete_table(u'groupsessions_battlevote')
    ...
    models = {
        ...
        u'groupsessions.groupsession': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_battle': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
